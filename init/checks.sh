...
_checkDefaultVars() {
    ...
    declare -rA def_vals=(
        ...
        [UPSTREAM_REPO]="https://github.com/TeamExtremis/ExtremisUserbot"
...
_setupPlugins() {
    ...
    if test $(grep -P '^'$2'$' <<< $3); then
        ...
        rm -rf extremis/plugins/$path/
        mv $tmp/plugins/ extremis/plugins/$path/
...
_checkUnoffPlugins() {
    _setupPlugins Xtra true $LOAD_UNOFFICIAL_PLUGINS https://github.com/TeamExtremis/extremis-Plugins.git
}
